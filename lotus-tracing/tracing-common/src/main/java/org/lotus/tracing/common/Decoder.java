package org.lotus.tracing.common;
...
public class Decoder {
    ...
    public static List<Span> decode(byte[] message){
        ...
        List<Span> span2s = new ArrayList<>();
